...
class PreferencesExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const PreferencesExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<PreferencesExpansionTile> createState() => PreferencesExpansionTileState();
}

class PreferencesExpansionTileState extends State<PreferencesExpansionTile> with SingleTickerProviderStateMixin {
